...
import { ArrowRight, CheckCircle, Search, Bell, Menu as MenuIcon, MoreHorizontal } from './Icons';
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <Parallax speed={0.2} className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full">
            <div className="absolute top-[10%] left-[10%] w-72 h-72 bg-zinc-100 rounded-full blur-[100px] opacity-80"></div>
            <div className="absolute top-[20%] right-[10%] w-96 h-96 bg-zinc-50 rounded-full blur-[120px] opacity-80"></div>
        </Parallax>
      </div>
        ...
        <div className="flex flex-col items-center">
            <ScrollReveal>
                <div className="inline-flex items-center px-3 py-1 rounded-full border border-zinc-200 bg-white shadow-sm mb-8">
                    ...
                    <span className="text-xs font-semibold text-zinc-900 tracking-wide uppercase">V 1.0 Já disponível</span>
                </div>
            </ScrollReveal>

            <ScrollReveal delay={100} width="w-full">
                <h1 className="text-5xl md:text-7xl font-display text-zinc-900 mb-6 leading-[1.1] tracking-tight">
                    Transforme 2 horas de<br className="hidden md:block"/> trabalho em <span className="text-orange-600 underline decoration-orange-200 decoration-4 underline-offset-4">5 minutos</span>
                </h1>
            </ScrollReveal>

            <ScrollReveal delay={200} width="w-full max-w-2xl">
                <p className="text-xl text-zinc-500 mb-10 leading-relaxed font-light">
                    Grave qualquer processo no seu navegador e deixe a IA criar documentação profissional automaticamente. 
                    <span className="hidden sm:inline"> Sem esforço. Sem capturas manuais.</span>
                </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={300} width="w-full">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button size="lg" className="group min-w-[200px]">
                        Começar Grátis <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </Button>
            ...
            <ScrollReveal delay={400}>
                <div className="mt-10 flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-zinc-500 font-medium">
                    <span className="flex items-center"><CheckCircle className="w-4 h-4 mr-2 text-zinc-900" /> Sem cartão de crédito</span>
                    <span className="flex items-center"><CheckCircle className="w-4 h-4 mr-2 text-zinc-900" /> +500 empresas</span>
                    <span className="flex items-center"><CheckCircle className="w-4 h-4 mr-2 text-zinc-900" /> 4.9/5 avaliação</span>
                </div>
            </ScrollReveal>
        </div>
                ...
                <div className="relative rounded-xl border border-zinc-200 bg-white shadow-2xl overflow-hidden">
                    ...
                    <div className="flex h-[400px] md:h-[500px] text-left">
                        ...
                        <div className="w-16 md:w-64 border-r border-zinc-100 bg-zinc-50/50 p-4 hidden md:flex flex-col gap-4">
                            <div className="h-8 w-8 rounded-lg bg-orange-600 mb-4 flex items-center justify-center text-white font-bold text-xs">P</div>
                        ...
                        <div className="flex-1 bg-white p-6 md:p-8 overflow-hidden relative">
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-8">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="p-4 rounded-xl border border-zinc-100 bg-white shadow-sm">
                            ...
                            <div className="space-y-3">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="flex items-center justify-between p-4 rounded-lg border border-zinc-100 hover:border-orange-200 transition-colors group">
